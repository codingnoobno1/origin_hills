...
const RITUALS: RitualParameter[] = [
  {
    ...
    type: "Floral Reserve • Assam Black & Rose Petals",
    temp: 92,
    timeSec: 210,
    leavesGrams: 3,
    vessel: "Pre-warmed Porcelain Teapot",
    description: "An elegant composition of premium orthodox black tea and hand-selected rose petals. Offers delicate floral notes balanced beautifully by the rich depth of Assam tea. Expected notes: Rose • Honey • Soft Spice.",
  },
  {
    id: "smoky-himalayan",
    name: "Smoky Himalayan Blend",
    type: "Mountain Reserve • Charcoal-fired Orthodox",
    temp: 95,
    timeSec: 270,
    leavesGrams: 3.5,
    vessel: "Wood-fired Claypot or Ceramic",
    description: "Inspired by mountain traditions and wood-fired techniques. Gentle smokiness unfolds gradually, revealing layered notes of cedarwood, deep malt character, and warmth. Expected notes: Smoke • Cedar • Malt.",
  },
  {
    id: "ceremonial-matcha",
    name: "Ceremonial Matcha",
    type: "Imperial Grade • Shade-grown Stone-ground Tencha",
    temp: 75,
    timeSec: 20,
    leavesGrams: 2,
    vessel: "Matcha Bowl (Chawan) & Bamboo Whisk (Chasen)",
    description: "Stone-ground imperial grade green tea crafted according to centuries-old Japanese tradition. Offers vibrant jade color, remarkable savory umami, and sweet cream. Expected notes: Umami • Cream • Fresh Grass.",
  },
  {
    id: "signature-assam",
    name: "Signature Assam Orthodox",
    type: "Assam Heritage • Tippy Golden Flowery Pekoe",
    temp: 95,
    timeSec: 240,
    leavesGrams: 3,
    vessel: "Traditional Porcelain Teapot",
    description: "The classic expression of upper Assam estates. Rich, bold body, deep amber liquor, and remarkable aromatic complexity. Expected notes: Malt • Deep Honey • Stonefruit.",
  },
];
